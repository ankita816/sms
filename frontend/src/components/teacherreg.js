    ...
    <div className="container">
        <div className="card shadow">
            <div className="card-header bg-success">
                <h1 className="card-title text-center text-white">-Teacher Registration-</h1>
            </div>
                ...
                <form action="">
                    ...
                    <div className="form-group">
                        ...
                        <input className="form-control border border-primary" type="text" name="name" id=""
                            placeholder="Write your name here" onChange={inputHandler}/>
                            </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        ...
                        <input className="form-control border border-primary" type="text" name="password" id="password"
                            placeholder="****" onChange={inputHandler}/>
                                                <div className="form-group">
                        <label for="name" className="font-weight-bold "> Confirm Your Password:</label>
                        <input className="form-control border border-primary" type="text" name="password" id="password"
                            placeholder="****" onChange={inputHandler}/>
                    <div className="form-group">
                        <label for="name" className="font-weight-bold">Email Address:</label>
                    ...
                    <div className="row">
                        <div className="form-group col-md-6 ">
                            ...
                            <input className="form-control border border-primary input-lg" type="text" name="class"
                                id="class" placeholder="Enter Your Class" onChange={inputHandler}/>
